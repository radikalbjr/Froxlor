...
* Customer
*/
$lng['customer']['documentroot'] = 'Directorio de usuario';
$lng['customer']['name'] = 'Apellido';                     
$lng['customer']['firstname'] = 'Nombre';
$lng['customer']['company'] = 'Compañía';
$lng['customer']['street'] = 'Calle';
$lng['customer']['zipcode'] = 'Código postal';
$lng['customer']['city'] = 'Ciudad';          
$lng['customer']['phone'] = 'Teléfono';
$lng['customer']['fax'] = 'Fax';
$lng['customer']['email'] = 'Correo';
$lng['customer']['customernumber'] = 'ID Cliente';  
$lng['customer']['diskspace'] = 'Espacio web (MiB)';
$lng['customer']['traffic'] = 'Tráfico (GiB)';
$lng['customer']['mysqls'] = 'Bases de datos-MySQL';  
$lng['customer']['emails'] = 'Direcciones de correo'; 
$lng['customer']['accounts'] = 'Cuentas de correo';   
$lng['customer']['forwarders'] = 'Reenvíos de correo';
$lng['customer']['ftps'] = 'Cuentas-FTP';
...
* Customermenue
*/
$lng['menue']['main']['main'] = 'Inicio';
$lng['menue']['main']['changepassword'] = 'cambiar contraseña';
$lng['menue']['main']['changelanguage'] = 'Cambiar idioma';    
$lng['menue']['email']['email'] = 'Correo';
$lng['menue']['email']['emails'] = 'Direcciones';
$lng['menue']['email']['webmail'] = 'Correo web';
$lng['menue']['mysql']['mysql'] = 'MySQL';
$lng['menue']['mysql']['databases'] = 'Bases de datos';
$lng['menue']['mysql']['phpmyadmin'] = 'phpMyAdmin';   
$lng['menue']['domains']['domains'] = 'Dominios';   
$lng['menue']['domains']['settings'] = 'Ajustes';
$lng['menue']['ftp']['ftp'] = 'FTP';
$lng['menue']['ftp']['accounts'] = 'Cuentas';
$lng['menue']['ftp']['webftp'] = 'Interfaz web para FTP';
$lng['menue']['extras']['extras'] = 'Extras';
$lng['menue']['extras']['directoryprotection'] = 'Protección de directorio';
$lng['menue']['extras']['pathoptions'] = 'Opciones de ruta';
/**
* Index
*/
$lng['index']['customerdetails'] = 'Detalles cliente';
$lng['index']['accountdetails'] = 'Detalles cuenta';
/**
* Change Password
*/
$lng['changepassword']['old_password'] = 'Contraseña actual';
$lng['changepassword']['new_password'] = 'Contraseña nueva';
$lng['changepassword']['new_password_confirm'] = 'Confirmar contraseña';
$lng['changepassword']['new_password_ifnotempty'] = 'Contraseña nueva (vacío = sin cambios)';
$lng['changepassword']['also_change_ftp'] = ' También cambia la contraseña a la cuenta principal de FTP';
/**
* Domains
*/
...
$lng['domains']['wildcarddomain'] = '¿Crear como dominio comodín?';
$lng['domains']['aliasdomain'] = 'Dominio con alias';              
$lng['domains']['noaliasdomain'] = 'Dominio sin alias';
/**
* E-mails
*/
...
$lng['emails']['catchall'] = 'Buzón global';
$lng['emails']['iscatchall'] = '¿Definir como buzón global?';
$lng['emails']['account'] = 'Cuenta';
$lng['emails']['account_add'] = 'Crear cuenta';
$lng['emails']['account_delete'] = 'Eliminar cuenta';
$lng['emails']['from'] = 'De';                       
$lng['emails']['to'] = 'Destino';
$lng['emails']['forwarders'] = 'Reenvíos';
$lng['emails']['forwarder_add'] = 'Crear reenvíos';
/**  
* FTP
*/
...
* MySQL
*/
$lng['mysql']['databasename'] = 'Usuario/Nombre de base de datos';
$lng['mysql']['databasedescription'] = 'Descripción de la base de datos';
$lng['mysql']['database_create'] = 'Crear base de datos';
/**
* Extras
*/
...
$lng['extras']['directory_browsing'] = 'Navegación de contenido del directorio';
$lng['extras']['pathoptions_edit'] = 'Editar opciones de ruta';
...
$lng['error']['directorymustexist'] = 'El directorio %s debe existir. Por favor, créelo desde su cliente FTP.';
...
$lng['error']['mustbeurl'] = 'No ha escrito una URL válida o completa (p.e. http://somedomain.com/error404.htm)';
$lng['error']['invalidpath'] = 'No ha escogido una URL válida (problemas con el dirlisting?)';
$lng['error']['stringisempty'] = 'Falta información en el campo';
$lng['error']['stringiswrong'] = 'información errónea en el campo';
$lng['error']['newpasswordconfirmerror'] = 'La nueva contraseña y la confirmación no coinciden';
$lng['error']['mydomain'] = '\'Domain\'';
$lng['error']['mydocumentroot'] = '\'Documentroot\'';
$lng['error']['loginnameexists'] = 'El usuario %s ya existe';
$lng['error']['emailiswrong'] = 'La dirección de correo %s contiene caracteres inválidos o está incompleta';
$lng['error']['loginnameiswrong'] = 'El nombre de usuario "%s" contiene caracteres ilegales.';
$lng['error']['loginnameiswrong2'] = 'Nombre de usuario demasiado largo. Máximo %s caracteres.';
$lng['error']['userpathcombinationdupe'] = 'Combinación de usuario y ruta, ya existe';
$lng['error']['patherror'] = '¡Error General! Ruta no puede estar vacía';
$lng['error']['errordocpathdupe'] = 'Opción para la ruta %s ya existe';  
$lng['error']['adduserfirst'] = 'Cree un cliente primero';
$lng['error']['domainalreadyexists'] = 'El dominio %s ya está asignado a un cliente';
$lng['error']['nolanguageselect'] = 'Idioma no seleccionado.';
$lng['error']['nosubjectcreate'] = 'Debe definir un asunto para esta plantilla de correo.';
$lng['error']['nomailbodycreate'] = 'Debe definir un texto para esta plantilla de correo.';
$lng['error']['templatenotfound'] = 'Plantilla no encontrada.';
$lng['error']['alltemplatesdefined'] = 'No puede definir más plantillas, ya están soportados todos los idiomas.';
$lng['error']['wwwnotallowed'] = 'No está permitido www para subdominios.';
...
$lng['error']['destinationalreadyexistasmail'] = 'El reenvío a %s ya existe como dirección de correo activa.';
$lng['error']['destinationalreadyexist'] = 'Ya se ha definido un reenvío a %s .';
$lng['error']['destinationiswrong'] = 'El reenvío %s contains invalid character(s) or is incomplete.';
